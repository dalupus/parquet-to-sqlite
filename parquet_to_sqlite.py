...
def convert_table(source, table, conn, skip_indexes):
...
def parquet_to_sqlite(source, destination, db_name, skip_indexes):
    ...
    for table in sorted(tables):
        convert_table(source, table, conn, skip_indexes)
...
def main():
    ...
    parquet_to_sqlite(source, destination, db_name, opts.skip_indexes)
...
def parse_arguments():
    ...
    parser.add_argument("--skip-indexes", help="Set this to bypass creating indexes", action='store_true')
